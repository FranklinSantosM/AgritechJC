...
* En el resumen, el objetivo de investigación no está clara.
* La metodología de investigación no tiende a ser reproducible.
* Los modelos de predicción no muestran ciertos detalles de precisión de cada modelo.
* Los coeficientes de determinación son relativamente bajos para determinar los modelos de predicción.
* La investigación es un gran aporte. Por tanto, se recomienda replicar esta investigación en condiciones del Altiplano Boliviano.
